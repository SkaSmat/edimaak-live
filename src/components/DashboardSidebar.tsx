...
export const DashboardSidebar = ({
  ...
  return (
    <Sidebar
      collapsible="icon"
      className="border-r border-sidebar-border bg-sidebar text-sidebar-foreground z-40 h-full"
    >
...
export const DashboardMobileHeader = ({
  ...
  const navigate = useNavigate();
  return (
    <header className="md:hidden flex items-center justify-between p-4 bg-background border-b border-border/50 z-50 w-full">
