...
import { ArrowLeft, Scale, Shield, Lock } from "lucide-react";
    ...
    <div className="min-h-screen bg-background font-sans">
      ...
      <header className="bg-card border-b border-border sticky top-0 z-50">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <h1 className="text-sm font-medium text-muted-foreground hidden sm:block">Centre Juridique</h1>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-6 sm:py-8 max-w-4xl">
        ...
        <div className="md:hidden flex gap-2 overflow-x-auto pb-4 mb-4 border-b border-border scrollbar-hide">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors whitespace-nowrap ${
              activeTab === "cgu" ? "bg-primary/10 text-primary" : "bg-muted text-muted-foreground"
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors whitespace-nowrap ${
              activeTab === "privacy" ? "bg-primary/10 text-primary" : "bg-muted text-muted-foreground"
            }`}
          >
        ...
        <div className="grid md:grid-cols-[250px_1fr] gap-8">
          ...
          <nav className="hidden md:block space-y-2 sticky top-24 h-fit">
            <p className="text-xs font-bold text-muted-foreground uppercase tracking-wider mb-4 px-2">Documents</p>

            <button
              onClick={() => setActiveTab("cgu")}
              className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors ${
                activeTab === "cgu" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:bg-muted"
              }`}
            >
              <Scale className="w-4 h-4" />
            ...
            <button
              onClick={() => setActiveTab("privacy")}
              className={`w-full flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-lg transition-colors ${
                activeTab === "privacy" ? "bg-primary/10 text-primary" : "text-muted-foreground hover:bg-muted"
              }`}
            >
              <Lock className="w-4 h-4" />
              ...
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    ...
                    <span className="font-bold text-foreground">
                      {" "}
                      Nous ne sommes ni transporteurs, ni commissionnaires de transport.
                    </span>
                ...
                <section className="space-y-3">
                  ...
                  <div className="bg-destructive/10 border border-destructive/20 rounded-lg p-4 text-sm text-destructive">
                    ...
                    Le Voyageur s'engage à <strong>toujours vérifier le contenu</strong> du colis avant de l'accepter.
                    Il est seul responsable devant les autorités douanières.
                  </div>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    ...
                    Les transactions financières et les accords de dédommagement relèvent de la responsabilité privée
                    des utilisateurs.
                  </p>
                </section>
              </div>
            ...
            {activeTab === "privacy" && (
              <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    EdiMaak s'engage à protéger la confidentialité de vos données personnelles. Cette politique décrit
                    comment nous collectons, utilisons et protégons vos informations lorsque vous utilisez notre
                    plateforme de mise en relation entre voyageurs et expéditeurs de colis.
                  </p>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <div className="bg-primary/5 border border-primary/20 rounded-lg p-4 mb-3">
                    ...
                    <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
                      <li>
                        <strong>Nom et prénom</strong> : pour créer votre profil utilisateur
                      </li>
                      <li>
                        <strong>Adresse email</strong> : pour l'authentification et les communications liées au service
                      </li>
                      <li>
                        <strong>Photo de profil</strong> (optionnel) : pour personnaliser votre profil
                      </li>
                    </ul>
                  </div>
                  ...
                  <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
                    <li>
                      <strong>Pièce d'identité</strong> : pour la sécurité de tous les utilisateurs
                    </li>
                    <li>
                      <strong>Numéro de téléphone</strong> : pour les communications relatives aux transactions
                    </li>
                    <li>
                      <strong>Détails des voyages et des colis</strong> : pour faciliter la mise en relation
                    </li>
                  </ul>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    Vos informations de profil (nom, photo) sont visibles par les autres utilisateurs uniquement lorsque
                    vous publiez une annonce ou contactez un autre utilisateur.
                    <strong className="text-foreground">
                      {" "}
                      Vos données de KYC (pièce d'identité, adresse exacte) restent strictement confidentielles
                    </strong>{" "}
                    et ne sont jamais partagées avec d'autres utilisateurs.
                  </p>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    ...
                    <strong className="text-foreground">Supabase</strong> (infrastructure AWS Europe), notre fournisseur
                    d'infrastructure qui respecte les normes de sécurité les plus élevées (ISO 27001, SOC 2). Toutes les
                    communications sont chiffrées via HTTPS.
                  </p>
                  <p className="text-muted-foreground text-sm leading-relaxed mt-2">
                    Vos données sensibles (pièce d'identité) sont stockées dans une table sécurisée séparée et ne sont
                    accessibles qu'aux administrateurs habilités pour validation KYC.
                  </p>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    ...
                    votre compte et de toutes vos données à tout moment en nous contactant ou via le bouton "Supprimer
                    mon compte" dans votre profil.
                  </p>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <ul className="list-disc pl-5 text-sm text-muted-foreground space-y-1">
                    ...
                    <li>
                      <strong>Droit de rectification</strong> : corriger vos informations personnelles
                    </li>
                    <li>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    EdiMaak utilise uniquement des cookies essentiels pour le fonctionnement du site (session
                    d'authentification). Nous n'utilisons pas de cookies publicitaires ou de tracking tiers.
                  </p>
                </section>
                ...
                <section className="space-y-3">
                  ...
                  <div className="bg-muted p-3 rounded-lg text-sm">
                    <p className="text-foreground">
                      <strong>Email :</strong>{" "}
                      <a href="mailto:skandersmatii@gmail.com" className="text-primary hover:underline">
                        skandersmatii@gmail.com
                      </a>
                    </p>
                    <p className="text-foreground mt-1">
                      <strong>Site web :</strong>{" "}
                      <a href="https://edimaak.com" className="text-primary hover:underline">
                        https://edimaak.com
                      </a>
                    </p>
                  </div>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-muted-foreground text-sm leading-relaxed">
                    ...
                    modifications seront publiées sur cette page avec une date de mise à jour actualisée.
                  </p>
                </section>
              </div>
            )}
